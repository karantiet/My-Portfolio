      ...
      >
        <MotionStack variants={stagger} spacing={6} w="100">
          ...
          <MotionText
            ...
            variants={fadeInUp}
          >
            Or you could call me KC. That works too . . .
          </MotionText>
          ...
          >
            ...
            end integration, recently found myself studying CLOUD too.
          </MotionText>
          <p>
          <MotionButton
            size="lg"
            ...
            as={'a'}
            href="mailto:chhabrakaran2003@gmail.com"
            target="_blank"
          ...
          <MotionButton
            ...
            variants={simpleOpacity}
            as={'a'}
            href="https://drive.google.com/file/d/1cXDRFXpVDk_6bmrf5XblxwmelHH-mnCi/view?usp=share_link"
            target="_blank"
            whileHover={{ scale: 0.9 }}
            whileTap={{ scale: 0.9 }}
          >
